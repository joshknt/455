...
-- Dumping structure for table testcs455.cis_major
CREATE TABLE IF NOT EXISTS `cis_major` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table testcs455.cis_major: ~28 rows (approximately)
/*!40000 ALTER TABLE `cis_major` DISABLE KEYS */;
INSERT INTO `cis_major` (`id`, `dept`, `course`, `credits`, `year`) VALUES
	(1, 'cs', '135', 3, 1),
	(2, 'cis', '225', 3, 1),
	(3, 'cis', '315', 3, 1),
	(4, 'cis', '330', 3, 1),
...
-- Dumping structure for table testcs455.cis_minor
CREATE TABLE IF NOT EXISTS `cis_minor` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `dept` varchar(50) NOT NULL DEFAULT '0',
  `course` varchar(50) NOT NULL DEFAULT '0',
  `credits` int(11) NOT NULL DEFAULT '0',
...
-- Dumping data for table testcs455.cis_minor: ~9 rows (approximately)
/*!40000 ALTER TABLE `cis_minor` DISABLE KEYS */;
INSERT INTO `cis_minor` (`id`, `dept`, `course`, `credits`, `year`) VALUES
	(1, 'cis', '225', 3, 1),
	(2, 'cis', '236', 3, 1),
	(3, 'cis', '330', 3, 1),
	(4, 'cis', '366', 3, 1),
...
INSERT INTO `cs_minor` (`id`, `dept`, `course`, `credits`, `year`) VALUES
	(1, 'cs', '155', 3, 1),
	(2, 'cs', '255', 3, 1),
	(3, 'cs', '355', 3, 1),
	(4, 'cs', '315', 3, 1),
...
-- Dumping structure for table testcs455.general_area1
CREATE TABLE IF NOT EXISTS `general_area1` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `dept` varchar(50) NOT NULL DEFAULT '0',
  `course` varchar(50) NOT NULL DEFAULT '0',
  `credits` int(11) NOT NULL DEFAULT '0',
...
-- Dumping data for table testcs455.general_area1: ~4 rows (approximately)
/*!40000 ALTER TABLE `general_area1` DISABLE KEYS */;
INSERT INTO `general_area1` (`id`, `dept`, `course`, `credits`, `year`) VALUES
	(1, 'en', '111', 3, 1),
	(2, 'en', '112', 3, 1),
	(3, 'en', '121', 3, 1),
	(4, 'en', '122', 3, 1);
...
-- Dumping structure for table testcs455.general_area2
CREATE TABLE IF NOT EXISTS `general_area2` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `dept` varchar(50) NOT NULL DEFAULT '0',
  `course` varchar(50) NOT NULL DEFAULT '0',
  `credits` int(11) NOT NULL DEFAULT '0',
...
-- Dumping data for table testcs455.general_area2: ~30 rows (approximately)
/*!40000 ALTER TABLE `general_area2` DISABLE KEYS */;
INSERT INTO `general_area2` (`id`, `dept`, `course`, `credits`, `year`) VALUES
	(1, 'com', '201', 3, 1),
	(2, 'en', '211', 3, 1),
	(3, 'en', '212', 3, 1),
	(4, 'en', '221', 3, 1),
...
-- Dumping structure for table testcs455.general_area3
CREATE TABLE IF NOT EXISTS `general_area3` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `dept` varchar(50) NOT NULL DEFAULT '0',
  `course` varchar(50) NOT NULL DEFAULT '0',
  `credits` int(11) NOT NULL DEFAULT '0',
...
-- Dumping data for table testcs455.general_area3: ~19 rows (approximately)
/*!40000 ALTER TABLE `general_area3` DISABLE KEYS */;
INSERT INTO `general_area3` (`id`, `dept`, `course`, `credits`, `year`) VALUES
	(1, 'ma', '112', 3, 1),
	(2, 'ma', '113', 3, 1),
	(3, 'ma', '115', 4, 1),
	(4, 'ma', '125', 4, 1),
...
-- Dumping structure for table testcs455.general_area4
CREATE TABLE IF NOT EXISTS `general_area4` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `dept` varchar(50) NOT NULL DEFAULT '0',
  `course` varchar(50) NOT NULL DEFAULT '0',
  `credits` int(11) NOT NULL DEFAULT '0',
...
-- Dumping data for table testcs455.general_area4: ~0 rows (approximately)
/*!40000 ALTER TABLE `general_area4` DISABLE KEYS */;
INSERT INTO `general_area4` (`id`, `dept`, `course`, `credits`, `year`) VALUES
	(1, 'hi', '101', 3, 1),
	(2, 'hi', '102', 3, 1),
	(3, 'hi', '201', 3, 1),
	(4, 'hi', '202', 3, 1),

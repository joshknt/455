...
// 	} else {
// 		fmt.Printf("Hours is out of range: %v. Needs to be within 0 and 5\nSenior Hours unchanged\n", hours)
// 	}
// }
...
// 	} else {
// 		fmt.Printf("Hours is out of range: %v. Needs to be within 1 and 5\nJunior-Senior Hours unchanged\n", hours)
// 	}
// }
...
// 	/*/--------------------------Begin Test Case ValidateSeniorCollegeHours 1----------
// 	//This will check if the number of senior hours is met to graduate
// 	//Expected input: 65 hours
...
// 	AddtoSeniorCollegeHours(5)
// 	fmt.Printf("Senior Hours: %v\n", GetSeniorCollegeHours())
// 	fmt.Printf("Senior Hours Validated: %v\n", ValidateSeniorCollegeHours())
// 	//Pass Log:
// 	//	4/26/2017 8:10 PM Passed
// 	//-----------------------------End Test Case------------------------------*/

// 	/*/--------------------------Begin Test Case ValidateSeniorCollegeHours 2----------
// 	//This will check if the number of senior hours is met to graduate
// 	//Expected input: 60 hours
// 	//Expected output: True
// 	AddtoSeniorCollegeHours(5)
// 	AddtoSeniorCollegeHours(5)
// 	AddtoSeniorCollegeHours(5)
...
// 	/*/--------------------------Begin Test Case ValidateSeniorCollegeHours 3----------
// 	//This will check if the number of senior hours is met to graduate
// 	//Expected input: 55 hours
...
// 	fmt.Printf("Senior Hours Validated: %v\n", ValidateSeniorCollegeHours())
// 	//Pass Log:
// 	//	4/26/2017 8:11 PM Passed
// 	//-----------------------------End Test Case------------------------------*/

// 	/*/--------------------------Begin Test Case ValidateJuniorSeniorHours 1----------
// 	//This will check if the number of junior-senior hours is met to graduate
// 	//Expected input: 39 hours
// 	//Expected output: True
// 	AddtoJuniorSeniorHours(3)
// 	AddtoJuniorSeniorHours(3)
// 	AddtoJuniorSeniorHours(3)
...
// 	AddtoJuniorSeniorHours(3)
// 	fmt.Printf("Junior-Senior Hours: %v\n", GetJuniorSeniorHours())
// 	fmt.Printf("Junior-Senior Hours Validated: %v\n", ValidateJuniorSeniorHours())
// 	//Pass Log:
// 	//	4/26/2017 8:10 PM Passed
// 	//-----------------------------End Test Case------------------------------*/

// 	/*/--------------------------Begin Test Case ValidateJuniorSeniorHours 2----------
// 	//This will check if the number of junior-senior hours is met to graduate
// 	//Expected input: 36 hours
// 	//Expected output: True
// 	AddtoJuniorSeniorHours(3)
// 	AddtoJuniorSeniorHours(3)
// 	AddtoJuniorSeniorHours(3)
...
// 	/*/--------------------------Begin Test Case ValidateJuniorSeniorHours 3----------
// 	//This will check if the number of junior-senior hours is met to graduate
// 	//Expected input: 33 hours
// 	//Expected output: True
// 	AddtoJuniorSeniorHours(3)
// 	AddtoJuniorSeniorHours(3)
// 	AddtoJuniorSeniorHours(3)
